...
namespace INFT6009.Services
{
    static partial class NotificationManager
    {
        ...
        static NotificationManager()
        {
            ...
            var channelName = "INFT6009 Test Channel";
            var channel = new NotificationChannel(CHANNEL_ID, channelName, NotificationImportance.Default);
            
            Android.App.NotificationManager notificationManager = Context.GetSystemService(Context.NotificationService)
    ...
    public class AlarmReceiver : BroadcastReceiver
    {
        ...
        public override void OnReceive(Context context, Intent intent)
        {
            ...
            //This adds extra data we could read when the notification is clicked, such as the id of the model to be shown
            ...
            NotificationCompat.Builder builder = new NotificationCompat.Builder(context, NotificationManager.CHANNEL_ID)
                ...
                .SetSmallIcon(Resource.Drawable.logo_fetch)
                .SetColor(color)
