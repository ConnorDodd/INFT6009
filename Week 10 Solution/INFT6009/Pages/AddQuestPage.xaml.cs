...
public partial class AddQuestPage : ContentPage
{
	...
	private void SaveButton_Clicked(object sender, EventArgs e)
	{
        ...
        //Show a notification when the quest is due
        DateTime notificationTime = model.Date.Add(model.Time);
        NotificationManager.SendNotification("Adventure Time!",
            "There is a quest starting now. Description: " + model.Description, notificationTime);

        //Show a confirmation popup
        NotificationManager.ShowToast("Quest added!");
    ...
    {
        //Get the user to confirm, return if they click No
        if (!await DisplayAlert("Delete", "Are you sure you want to delete this Quest? This cannot be undone.", "Yes", "No"))
            return;
        //Delete model from database
        DatabaseService.DeleteQuest(model);
        //Close page
        Shell.Current.Navigation.PopAsync();
    }
